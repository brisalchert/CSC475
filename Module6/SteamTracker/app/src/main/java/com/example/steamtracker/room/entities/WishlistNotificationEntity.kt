...
@Entity(tableName = "wishlist_notifications")
data class WishlistNotificationEntity(
...
@Entity(
    tableName = "app_details_notifications",
    primaryKeys = ["timestamp", "steamAppId"],
    foreignKeys = [
        ForeignKey(
            entity = WishlistNotificationEntity::class,
...
data class AppDetailsNotificationEntity(
